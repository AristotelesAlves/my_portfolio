export function Header() {
    return (
        <header className="w-full sticky top-4 left-0 flex items-center justify-center z-50">
            <ul className="flex px-10 py-4 bg-black/50 backdrop-blur-md border-2 rounded-2xl border-[#303030] text-white gap-10">

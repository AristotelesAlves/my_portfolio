import { BriefcaseBusinessIcon, GithubIcon, Instagram, Linkedin, Mail, Phone, } from "lucide-react";
...
export default function LinkTree() {
    ...
    return (
        <div className="flex flex-col gap-2 h-full py-5 w-screen items-center justify-center" style={{
            ...
            <div className="bg-black border-2 rounded-3xl border-[#303030] md:w-fit w-[90%] shadow-md hfull overflow-hidden text-white flex flex-col pb-5">
                ...
                <div className="flex w-full flex-col">
                    ...
                    <nav className="w-full flex justify-between text-[#454242] px-20 py-8">
                        <a className="hover:text-green-700 transition-colors duration-150" href="https://linkedin.com/in/aristóteles-alves-ab8089226"><Linkedin /></a>
                        <a className="hover:text-green-700 transition-colors duration-150" href="https://www.instagram.com/aristoteles269/"><Instagram /></a>
                    ...
                    <nav className="flex flex-col w-full items-center justify-center gap-4 h-full">
                        ...
                        <a className="w-[90%] flex gap-3 bg-[#191919] px-2 py-4 p-2 border-2 rounded-2xl border-[#303030] hover:border-green-700 transition-colors duration-500" href="https://github.com/AristotelesAlves">
                            <GithubIcon className="text-[#454242]" />
                            <span>
                                {t.openSource}
                            </span>
                        </a>

                        <div className="w-[90%] flex flex-col h-full gap-3 bg-[#191919] p-2 border-2 rounded-2xl border-[#303030] hover:border-green-700 transition-colors duration-500">
                            <h2>
                                {t.lastProject}
                            </h2>
                            <img className="w-full h-full border-[#303030] hover:border-green-700 border-2 rounded-xl object-cover object-[center_0%]" src="/imgs/salada.png" alt="" />
                        </div>
                    </nav>
                </div>
            </div>
            <span className="text-[#CCCCCC]  italic text-sm font-light mt-4">
                {t.copyright}
            </span>
        </div>
    )
